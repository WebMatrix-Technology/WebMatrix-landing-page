...
_s(ThemeProvider, "5/ogEZMvd1bjFaXe66chkFiGjww=");
_c = ThemeProvider;
const useTheme = ()=>{
    _s1();
...
"[project]/src/contexts/AdminAuth.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://yubdimqdfcgckjqhjnmy.supabase.co");
const supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl1YmRpbXFkZmNnY2tqcWhqbm15Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjI3NjgzNzUsImV4cCI6MjA3ODM0NDM3NX0.kWUJk1EqfCIJDzwsUwV5Lfmgq4-2FFsn3SUbrng6eNo");
// Validate Supabase configuration
if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
;
const supabase = ("TURBOPACK compile-time truthy", 1) ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseKey) : "TURBOPACK unreachable";
...
const AdminAuthProvider = ({ children })=>{
    ...
    const allowed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminAuthProvider.useMemo[allowed]": ()=>{
            const raw = (("TURBOPACK compile-time value", "shubs.work@company.co,jay.work@company.co,abhi@work@company.co") || '').trim();
            return raw ? raw.split(',').map({
                "AdminAuthProvider.useMemo[allowed]": (e)=>e.trim().toLowerCase()
            }["AdminAuthProvider.useMemo[allowed]"]).filter(Boolean) : [];
        }
    }["AdminAuthProvider.useMemo[allowed]"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminAuthProvider.useEffect": ()=>{
            ...
            supabase.auth.getSession().then({
                "AdminAuthProvider.useEffect": ({ data: { session } })=>{
            ...
            const { data: listener } = supabase.auth.onAuthStateChange({
                "AdminAuthProvider.useEffect": (_event, session)=>{
                    const u = session?.user ?? null;
                    if (u && allowed.length > 0 && !allowed.includes((u.email || '').toLowerCase())) {
                        supabase.auth.signOut();
                        setUser(null);
    ...
    const login = async (email, password)=>{
        ...
        if (allowed.length > 0 && !allowed.includes(email.toLowerCase())) {
            return {
                error: 'This email is not allowed to access admin.'
            };
        }
        try {
            ...
            return {
                error: 'Failed to connect to authentication service. Please check your internet connection and Supabase configuration.'
            };
        }
    };
    const logout = async ()=>{
    ...
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminAuthProvider.useMemo[value]": ()=>({
                ...
                logout,
                isEmailAllowed: ({
                    "AdminAuthProvider.useMemo[value]": (email)=>allowed.length === 0 ? true : allowed.includes(email.toLowerCase())
                })["AdminAuthProvider.useMemo[value]"],
                getAccessToken: ({
                    "AdminAuthProvider.useMemo[value]": async ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AdminAuthContext.Provider, {
        ...
        fileName: "[project]/src/contexts/AdminAuth.tsx",
        lineNumber: 119,
        columnNumber: 5
    }, ("TURBOPACK compile-time value", void 0));
};
_s(AdminAuthProvider, "ws3vESfy4hX+svtPbCAIVTo3eOM=");
...
_s1(useAdminAuth, "/dMy7t63NXD4eYACoT93CePwGrg=");
var _c;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryClientProvider"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$ThemeContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeProvider"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tooltip$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TooltipProvider"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AdminAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AdminAuthProvider"], {
                    children: [
                        children,
...
//# sourceMappingURL=src_a5add4bc._.js.map