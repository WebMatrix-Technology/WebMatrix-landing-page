    ...
    <div className="min-h-screen pt-32 pb-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          >
            <Card className="border-border/60 dark:border-border/50 bg-card/50 dark:bg-card">
            ...
            <Card className="border-border/60 dark:border-border/50 bg-gradient-to-br from-primary/5 to-accent/5 dark:from-primary/5 dark:to-accent/5">
              <CardContent className="p-6">
