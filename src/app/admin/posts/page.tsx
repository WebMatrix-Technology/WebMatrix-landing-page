        ...
        <CardContent>
          <form onSubmit={submit} className="grid md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 space-y-2">
              ...
              <Input id="tags" value={Array.isArray(form.tags) ? form.tags.join(', ') : (form.tags as unknown as string) || ''} onChange={(e) => setForm(f => ({ ...f, tags: e.target.value as unknown as string[] }))} />
            </div>
            <div className="md:col-span-2 space-y-2">
