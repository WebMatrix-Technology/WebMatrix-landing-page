...
import React, { useCallback, useEffect, useState, useRef, type CSSProperties } from 'react';
...
export default function AdminProjectsPage() {
  ...
  }, [getAccessToken, mapProject, sortProjects, filterFeatured]);
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <ImageDropzone
                      ...
                      onImageSelected={({ url, dataUrl }) => {
                        // Prefer URL from Supabase Storage, fallback to base64 dataUrl
                        setForm((f) => ({ ...f, mobileImage: url || dataUrl }));
                      }}
                      getAccessToken={getAccessToken}
                    />
                    {form.mobileImage && (
